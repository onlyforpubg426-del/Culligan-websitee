...
export default function AboutWater() {
  usePageMeta({
    title: "About Pure Water",
    description: "Learn why water quality matters and how Culligan Pakistan's RO purification and ozone treatment deliver the safest, cleanest drinking water in Karachi.",
    path: "/about-water",
  });
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <main className="pt-14">
        ...
        >
          <div className="absolute top-0 right-0 w-[480px] h-[480px] rounded-full pointer-events-none opacity-40" style={{ background: "radial-gradient(circle, #bfdbfe 0%, transparent 65%)", transform: "translate(32%,-32%)" }} />
          ...
          <div className="container mx-auto px-4 md:px-6 py-12 md:py-18 relative z-10">
            ...
            >
              <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full mb-5 border" style={{ background: "linear-gradient(135deg,#eff6ff,#dbeafe)", borderColor: "#bfdbfe" }}>
                ...
                <span className="text-[11px] font-extrabold tracking-[0.22em] uppercase text-blue-600">About Bottled Water</span>
              </div>
              <h1 className="text-4xl md:text-5xl font-black text-slate-900 leading-tight mb-5">
                Pure water.{" "}
                <span className="relative inline-block">
                  <span className="relative z-10" style={{ color: "#1976d2" }}>Pure difference.</span>
        ...
        <section className="container mx-auto px-4 md:px-6 py-16 max-w-5xl">
          <div className="mb-10">
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full mb-4 border" style={{ background: "linear-gradient(135deg,#eff6ff,#dbeafe)", borderColor: "#bfdbfe" }}>
              <span className="w-1.5 h-1.5 rounded-full bg-blue-500" />
              <span className="text-[11px] font-extrabold tracking-[0.22em] uppercase text-blue-600">Hydration</span>
            </div>
            <h2 className="text-3xl font-black text-slate-900">Why you should drink <span style={{ color: "#1976d2" }}>more water</span></h2>
        ...
        <section
          className="relative border-y border-blue-100 overflow-hidden"
        ...
        >
          ...
          <div className="container mx-auto px-4 md:px-6 py-16 max-w-5xl relative z-10">
            <div className="mb-10">
              <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full mb-4 border" style={{ background: "linear-gradient(135deg,#eff6ff,#dbeafe)", borderColor: "#bfdbfe" }}>
                <span className="w-1.5 h-1.5 rounded-full bg-blue-500" />
                <span className="text-[11px] font-extrabold tracking-[0.22em] uppercase text-blue-600">Purification</span>
              </div>
              <h2 className="text-3xl font-black text-slate-900">How we <span style={{ color: "#1976d2" }}>purify our water</span></h2>
              <p className="text-slate-500 mt-3 max-w-xl text-sm leading-relaxed">
        ...
        <section className="container mx-auto px-4 md:px-6 py-16 max-w-5xl">
          <div className="mb-10">
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full mb-4 border" style={{ background: "linear-gradient(135deg,#eff6ff,#dbeafe)", borderColor: "#bfdbfe" }}>
              <span className="w-1.5 h-1.5 rounded-full bg-blue-500" />
              <span className="text-[11px] font-extrabold tracking-[0.22em] uppercase text-blue-600">Certifications</span>
            </div>
            <h2 className="text-3xl font-black text-slate-900">Quality standards <span style={{ color: "#1976d2" }}>we meet</span></h2>
            <p className="text-slate-500 mt-3 max-w-xl text-sm leading-relaxed">
        ...
        >
          ...
          <div className="container mx-auto px-4 md:px-6 py-16 max-w-5xl relative z-10">
            <div className="mb-10">
              <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full mb-4 border" style={{ background: "linear-gradient(135deg,#eff6ff,#dbeafe)", borderColor: "#bfdbfe" }}>
                <span className="w-1.5 h-1.5 rounded-full bg-blue-500" />
                <span className="text-[11px] font-extrabold tracking-[0.22em] uppercase text-blue-600">Container Sizes</span>
              </div>
              <h2 className="text-3xl font-black text-slate-900">Which bottle size is <span style={{ color: "#1976d2" }}>right for you?</span></h2>
              <p className="text-slate-500 mt-3 max-w-xl text-sm leading-relaxed">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-3 sm:gap-4">
              {containerSizes.map((c, i) => (
                ...
                >
                  ...
                  {/* Image */}
                  <div className="flex items-end justify-center pt-4 pb-2 px-4 h-28 sm:h-36 bg-white/60">
                    <img
                      src={c.image}
        ...
        <section className="container mx-auto px-4 md:px-6 py-16 max-w-5xl">
          <div className="mb-8">
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full mb-4 border" style={{ background: "linear-gradient(135deg,#eff6ff,#dbeafe)", borderColor: "#bfdbfe" }}>
              <span className="w-1.5 h-1.5 rounded-full bg-blue-500" />
              <span className="text-[11px] font-extrabold tracking-[0.22em] uppercase text-blue-600">Packaging</span>
            </div>
            <h2 className="text-3xl font-black text-slate-900">Is PET plastic <span style={{ color: "#1976d2" }}>safe?</span></h2>
          </div>
