              ...
              <div className="px-6 py-5 space-y-3">
                ...
                <div className="rounded-2xl border border-slate-100 overflow-hidden">
                  <table className="w-full text-sm">
                    <tbody>
                      <tr className="border-b border-slate-50">
                        <td className="px-4 py-2.5 text-slate-500">Coupon book price</td>
                        <td className="px-4 py-2.5 text-right font-bold text-sky-700">Rs. 4,070 (11 coupons)</td>
                      </tr>
                      <tr className="border-b border-slate-50">
                        <td className="px-4 py-2.5 text-slate-500">Price per bottle via coupon</td>
                        <td className="px-4 py-2.5 text-right font-bold text-sky-700">Rs. 370</td>
                      </tr>
                      <tr>
                        <td className="px-4 py-2.5 text-slate-500">Saving vs. cash</td>
                        <td className="px-4 py-2.5 text-right font-bold text-emerald-600">Rs. 10 (2.9%)</td>
                      </tr>
                    </tbody>
                  </table>
                </div>
  ...
  return (
    <>
      ...
      >
        ...
        <div className="absolute top-0 right-0 w-[500px] h-[500px] rounded-full bg-blue-50/80 blur-3xl pointer-events-none -translate-y-1/2 translate-x-1/3" />
        <div className="absolute bottom-0 left-0 w-[400px] h-[400px] rounded-full bg-sky-50/80 blur-3xl pointer-events-none translate-y-1/2 -translate-x-1/3" />
        ...
        <div className="container mx-auto px-4 md:px-6 relative z-10">
          <div className="text-center mb-14">
            ...
            <motion.p
              ...
              className="mt-4 text-lg text-slate-500 max-w-xl mx-auto leading-relaxed"
            >
              ...
              const card = (
                <motion.div
                  ...
                  className={`group relative rounded-2xl p-6
                             ...
                             shadow-sm hover:shadow-xl hover:shadow-slate-200/60 hover:border-slate-200
                             transition-all duration-300 flex flex-col
                             ${isClickable ? "cursor-pointer" : ""}`}
                >
                  <div className={`w-12 h-12 rounded-2xl ${service.bg} border ${service.border} flex items-center justify-center mb-5 ${service.accent} group-hover:text-white transition-all duration-300`}>
                    <Icon className={`h-6 w-6 ${service.color} group-hover:text-white transition-colors duration-300`} />
                  </div>
                  <h3 className="font-bold text-slate-900 text-base mb-2 group-hover:text-primary transition-colors duration-200">{service.title}</h3>
                  ...
                  {isOfficeGuide && (
                    <span className="mt-3 text-xs font-semibold text-sky-600 group-hover:underline">
                      View office delivery →
                    </span>
                  )}
                  {isDispensers && (
                    <span className="mt-3 text-xs font-semibold text-[#42a5f5] group-hover:underline">
                      View options →
                    </span>
                  )}
                  {isCoolerGuide && (
                    <span className="mt-3 text-xs font-semibold text-violet-600 group-hover:underline">
                      View cleaning guide →
                    </span>
                  )}
                  {isShopFinder && (
                    <span className="mt-3 text-xs font-semibold text-amber-600 group-hover:underline">
                      View our shops →
                    </span>
                  )}
                  {isContactPage && (
                    <span className="mt-3 text-xs font-semibold text-teal-600 group-hover:underline">
                      Send us a message →
                    </span>
                  )}
                  {isCorporatePage && (
