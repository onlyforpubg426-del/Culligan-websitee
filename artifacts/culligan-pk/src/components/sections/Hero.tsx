...
export function Hero() {
  return (
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        {[
          { size: 9,  left: "4%",  dur: "22s",  delay: "0s",    cls: "bubble-rise"      },
          { size: 24, left: "7%",  dur: "36s",  delay: "8s",    cls: "bubble-rise-slow" },
          { size: 18, left: "10%", dur: "32s",  delay: "3.5s",  cls: "bubble-rise-slow" },
          { size: 7,  left: "16%", dur: "20s",  delay: "1.2s",  cls: "bubble-rise"      },
          { size: 26, left: "21%", dur: "38s",  delay: "0.5s",  cls: "bubble-rise-slow" },
          { size: 32, left: "25%", dur: "44s",  delay: "12s",   cls: "bubble-rise-slow" },
          { size: 11, left: "28%", dur: "24s",  delay: "4.8s",  cls: "bubble-rise"      },
          { size: 6,  left: "34%", dur: "18s",  delay: "2.2s",  cls: "bubble-rise"      },
          { size: 28, left: "37%", dur: "40s",  delay: "5s",    cls: "bubble-rise-slow" },
          { size: 20, left: "40%", dur: "30s",  delay: "6s",    cls: "bubble-rise-slow" },
          { size: 8,  left: "47%", dur: "21s",  delay: "1.8s",  cls: "bubble-rise"      },
          { size: 34, left: "50%", dur: "46s",  delay: "9s",    cls: "bubble-rise-slow" },
          { size: 14, left: "53%", dur: "26s",  delay: "0.9s",  cls: "bubble-rise"      },
          { size: 30, left: "60%", dur: "42s",  delay: "3s",    cls: "bubble-rise-slow" },
          { size: 9,  left: "66%", dur: "22s",  delay: "5.5s",  cls: "bubble-rise"      },
          { size: 27, left: "69%", dur: "39s",  delay: "14s",   cls: "bubble-rise-slow" },
          { size: 16, left: "72%", dur: "28s",  delay: "2.7s",  cls: "bubble-rise"      },
          { size: 5,  left: "78%", dur: "18s",  delay: "0.3s",  cls: "bubble-rise"      },
          { size: 22, left: "83%", dur: "35s",  delay: "4.2s",  cls: "bubble-rise-slow" },
          { size: 29, left: "87%", dur: "41s",  delay: "10s",   cls: "bubble-rise-slow" },
          { size: 10, left: "89%", dur: "23s",  delay: "1.5s",  cls: "bubble-rise"      },
          { size: 7,  left: "94%", dur: "20s",  delay: "3.8s",  cls: "bubble-rise"      },
          { size: 23, left: "97%", dur: "37s",  delay: "7s",    cls: "bubble-rise-slow" },
        ].map((b, i) => (
