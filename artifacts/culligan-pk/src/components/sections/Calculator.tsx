...
import { TrendingDown, Droplets, Users, Package, ArrowRight, CheckCircle2 } from "lucide-react";
              ...
              <div className="grid lg:grid-cols-2 gap-6">
                ...
                <div className="shadow-card rounded-3xl border border-slate-100 bg-white p-7 space-y-8">
                  ...
                  <div className="grid grid-cols-2 gap-3 pt-2 border-t border-slate-100">
                    {[
                      { label: "Daily need",   value: `${dailyLiters.toFixed(1)}L`,    icon: "💧" },
                      { label: "Monthly need", value: `${monthlyLiters.toFixed(0)}L`,   icon: "📅" },
                    ].map((s) => (
                ...
                <div className="flex flex-col gap-4">
                  ...
                  <div className="shadow-card-blue rounded-3xl border border-blue-200/50 bg-white p-6">
                    ...
                    <a
                      href="#order"
                      className="btn-cta-primary mt-5 flex items-center justify-center gap-2
                                 rounded-2xl h-12 text-[14px] font-bold text-white"
                      style={{ background: "linear-gradient(135deg,#2196f3,#42a5f5)" }}
                    >
