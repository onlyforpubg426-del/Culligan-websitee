...
const WA_URL = "https://wa.me/923222584525?text=" + encodeURIComponent(
    ...
    <AnimatePresence>
      {visible && (
        <motion.a
          ...
          className="fixed bottom-8 right-6 z-50 w-14 h-14 rounded-full bg-[#25D366] flex items-center justify-center shadow-xl shadow-green-500/30"
        >
          <svg
