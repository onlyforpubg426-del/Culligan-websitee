                          ...
                          <div className="flex flex-col items-end gap-2 shrink-0">
                            ...
                            <div className="flex items-center gap-1.5 bg-white border border-slate-200 rounded-xl px-2 py-1.5 shadow-sm">
                              <button
                                ...
                                className="w-5 h-5 rounded-lg hover:bg-red-50 flex items-center justify-center transition-colors group"
                                aria-label={item.qty <= item.minQty ? "Remove item" : "Decrease quantity"}
                              >
                            ...
                            {item.minQty > 1 && (
                              <p className="text-[10px] text-slate-400 font-medium">Min. {item.minQty}</p>
                            )}
                          </div>
                        </motion.div>
                      ))}
