...
import { z } from "zod";
import { subscriptions, createSubscription, type SubscriptionStatus } from "../lib/store";
...
router.post("/subscriptions", (req, res) => {
  ...
  const subscription = createSubscription(result.data);
...
router.patch("/subscriptions/:id/status", (req, res) => {
  ...
  subscription.status = result.data.status as SubscriptionStatus;
